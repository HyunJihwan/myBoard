...
<div class="content-wrapper">
	<jsp:include page="../content_header.jsp">
		<jsp:param value="회원게시판리스트" name="subject"/>
			...
			<div class="card-header with-border">
				...
				<div class="card-tools" style="width: 350px;">
					<div class="input-group row">
						<select class="form-cotrol col-md-4" name="searchType" id="searchType">
					...
					<table class="table table-borderd text-center">
						...
						<tr style="font-size: 0.85em;">
							...
							<td style="text-align:left;">
								<a href="javascript:OpenWindow('detail.do?bno=${board.bno}','안녕하세요',650,750);" onclick="">
