				...
				<div class="row">
					<div class="col-sm-12">
						...
						<c:forEach items="${memberList }" var="member">
							<tr style = "${member.enabled eq 1 ?  'background-color : gray;'  :  'background-color: red;'}">
								<td><a href=""onclick="OpenWindow('memberStatus.do?id=${member.id }', '회원상세보기', 650, 750);">${member.id }</a></td>
								<td>${member.pwd }</td>
								<td>${member.email }</td>
