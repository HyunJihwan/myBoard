					...
					<form role="form" class="form-horizontal" method="post">
						...
						<div class="row">
							<div class="mailbox-attachments clearfix col-md-12" style="text-align: center;">
								<div id="pictureView" style="border: 1px solid green; height: 180px; width: 150px; margin: 0 auto;"></div>
							</div>
						</div>
						<br>
						...
						<div class="card-footer">
							<div class="row">
								...
								<div class="col-sm-3 text-center">
									<button type="button" id="modifyBtn" class="btn btn-warning" onclick="" style="display:${visible}">수 정</button>
								</div>
								<div class="col-sm-3 text-center">
									<button type="button" id="deleteBtn" class="btn btn-danger" onclick=""  style="display:${visible}">삭 제</button>
								</div>
								<div class="col-sm-3 text-center">
									<button type="button" id="stopBtn" class="btn btn-secondary" onclick=""  style="display:${visible}">${member.enabled eq 1 ?  '정 지'  :  '해 제'}</button>
								</div>
								<div class="col-sm-3 text-center">
									<button type="button" id="listBtn" class="btn btn-dark" onclick="CloseWindow();" >닫 기</button>
								</div>
							</div>
						</div>
					</form>
...
<%@ include file="memberStatus_js.jsp" %>